context ('Snippets', () => {
    describe('Snippets UI', () => {
        ...
        it('Create a Vast - Instream Snippet successfully', () => {
            ...
            cy.get(':nth-child(3) > div.my-2 > .form-control').type('https://springhillcompany.com'); // Type valid https
            cy.get('.row > :nth-child(1) > :nth-child(1) > .form-control').type('Go Hawks'); // Type creative title
